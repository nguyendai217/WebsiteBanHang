...
<link rel="stylesheet" href='<c:url value="/resources/css/morris.css"></c:url>' />
<!-- Graph CSS -->
...
<!-- lined-icons -->
<link rel="stylesheet" href='<c:url value="/resources/css/icon-font.min.css"></c:url>' />
<!-- //lined-icons -->
</head> 
<body>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="#"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 <li id="menu-academico" ><a href='<c:url value="admin/addsanpham"></c:url>'><i class="fa fa-envelope nav_icon"></i><span>Sản Phẩm </span><div class="clearfix"></div></a></li>
